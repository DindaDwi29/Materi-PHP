...
<form>
    ...
    <br>
    <center><p>1. Deret Bilangan Ganjil</p>
        <p>2. Segitiga Sama Kaki Terbalik</p>
        <p>3. Deret Bilangan Kelipatan 3</p>
    </center>
  <div class="form-group">
    <label for="exampleInputEmail1">Pilih : </label>
    <input type="text" name="pilih" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp">
    <small id="emailHelp" class="form-text text-muted"></small>
  </div>
  <div class="form-group">
    <label for="exampleInputPassword1">Masukan Angka :</label>
